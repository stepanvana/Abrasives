	...
	<script type="text/javascript">
		...
		google.charts.setOnLoadCallback(drawAnthonyChart);
  		...
  		function drawAnthonyChart() {
			...
			var options = {
					hAxis: {title: 'Měsíc',  titleTextStyle: {color: 'white'}, textStyle: {color: 'white'}},
					vAxis: {title: 'Počet',  titleTextStyle: {color: 'white'},minValue: 0, textStyle: {color: 'white'}, gridlines: {color: 'white'}, baselineColor: 'white'},
			        ...
			        <div class="row">
			        	<div class="col-lg-3 col-md-12 mb-4">
					        <div class="media white z-depth-1 rounded">
								...
								<div class="media-body p-1">
									<p class="text-uppercase text-muted mb-1"><small>Počet objednávek</small></p>
			        	...
			        	<div class="col-lg-3 col-md-12 mb-4">
					        <div class="media white z-depth-1 rounded">
								...
								<div class="media-body p-1">
									<p class="text-uppercase text-muted mb-1"><small>Průměrná cena objednávky</small></p>
									<h5 class="mb-0">
										<?php 
			        	...
			        	<div class="col-lg-3 col-md-12 mb-4">
					        <div class="media white z-depth-1 rounded">
								...
								<div class="media-body p-1">
									<p class="text-uppercase text-muted mb-1"><small>Denní počet objednávek</small></p>
			...
			<div class="row wow fadeIn" style="margin-bottom: 6%;">
				<div class="col-md-12 mb-4">
					...
					if (isset($_GET['error'])) {
						?>
						<div class="alert alert-danger alert-dismissible fade show" role="alert">
						  	<strong>Žádné data ve výběru!</strong> Ve zvoleném rozsahu dat se nenachází žádné objednávky, prosím vyberte jiný rozsah.
						  	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						    	<span aria-hidden="true">&times;</span>
						  	</button>
						</div>
