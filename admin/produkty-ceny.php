...
if (isset($_SESSION['userId'])) {
	...
	if (isset($_POST['saveProductsPrices'])) {
		$productsContrObj->saveProductsPrices($_POST['ids'], $_POST['productPrice'], $_POST['productDiscount'], $_POST['productPurchasePrice']);
	}
      		...
      		<div class="container-fluid">
        		...
        		<div class="collapse navbar-collapse" id="navbarSupportedContent">
		          	...
		          	<ul class="navbar-nav nav-flex-icons">
			            ...
			            <li class="nav-item">
			              	<button id="save" type="submit" name="saveProductsPrices" class="btn btn-outline-success btn-md waves-effect">Uložit</button>
			            </li>
			            <li class="nav-item">
				            <a href="user.php">
			            			...
			            			<table id="dtBasicExample" class="table table-hover table-bordered table-sm" cellspacing="0" width="100%">
					                	<thead class="blue lighten-4">
					                  		<tr>
					                    		...
					                    		<th class="th-sm">Podategorie</th>
					                    		<th class="th-sm">Cena</th>
					                    		<th class="th-sm">Nákupní cena</th>
					                    		<th class="th-sm">Sleva</th>
					                    		<th class="th-sm">Cena po slevě</th>
					                  		</tr>
					                	</thead>
						  				<tbody>
					                  		<?php
						                  			...
						                  			<tr>
						                  				...
						                  				<td>
						                  					<div class="md-form form-sm" style="margin: 0;padding: 0;">
															  	<input name="productPrice[]" type="text" id="productPrice" class="form-control form-control-sm unsaved" value="<?php echo $row['product_price']; ?>" required>
															</div>
														</td>
						                  				<td>
						                  					<div class="md-form form-sm" style="margin: 0;padding: 0;">
															  	<input name="productPurchasePrice[]" type="text" id="productPurchasePrice" class="form-control form-control-sm unsaved" value="<?php echo $row['product_purchase_price']; ?>" required>
															</div>
														</td>
														<td>
						                  					<div class="md-form form-sm" style="margin: 0;padding: 0;">
															  	<input name="productDiscount[]" type="text" id="productDiscount" class="form-control form-control-sm unsaved" value="<?php echo $row['product_discount']; ?>" required>
															</div>
														</td>
														<td>
						                  					<div class="md-form form-sm" style="margin: 0;padding: 0;">
															  	<input type="text" id="productFinalPrice" class="form-control form-control-sm" value="<?php echo $row['product_price']*(1-($row['product_discount']/100)); ?>" required disabled>
															</div>
														</td>
